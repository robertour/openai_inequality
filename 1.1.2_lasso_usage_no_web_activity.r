...
dependant <- "chatgpt_usage"
family <- "binomial"
transformation <- "flat"
theta <- NULL
include_zeroes <- "no_web_activity"
nfold <- 10
n_iterations <- 1000
sample_partition <- 0.5
seed <- 2023
n_plots_to_save <- 10
...
df <- filter_df(df, "data/raw/survey_independent_variables.txt", include_zeroes, dependant)
